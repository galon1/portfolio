...
class Projects extends React.Component {
    ...
    render() {
        ...
        const descriptions = [`First author of a published paper assessing the quality of machine learning classifers in diagnostic support. Organized
            ...
            `Built an automated process for onboarding new members. This process involved creating 2 new web pages which I designed and using 5 APIs (Typeform, Airtable, Google, Zingle, Sendgrid) and 2 webhooks.
            Also, I built features for the website such as individualized member profile pages and allowing members to bookmark posts and filter posts
            based on date. All features were built using React.`, `I worked with a small business client to build a professional website for her Speech Language Pathologist private clinic.
